...
set.seed(123)
hours_slept = rnorm(n = 128, mean = 6, sd = 2)
num_pacifiers = rnorm(n = 128, mean = )
```

We could have used a different distribution for this as well. For example, a uniform distribution (*runif*) a
