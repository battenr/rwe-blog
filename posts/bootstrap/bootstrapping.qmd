...
To try and determine this, you take a spoonful of vanilla from the bowl then a spoonful of chocolate. You do this over and over until you have a new bowlful. This is magical ice cream, so once you take a spoonful, that same flavour and amount appears in the bowl again (aka it's *replaced*). This new bowl of ice cream is 60% chocolate and 40% vanilla. You put it back then do it all over again and notice it's 80% vanilla and 20% chocolate. If you do this over and over again, you can use this to try and get an idea of what the big tub in the back looks like.\
\
...
1.  Draw 100 scores, from any day (randomly) and write them down. We are doing this with replacement, so the same score can appear twice.
2.  Put them back.
