...
We've got some data! Now, we want to calculate our 95% CIs from a GLM. To do this, we first need to sample some data, then fit a GLM and repeat, repeat, repeat as many times as we have chosen. So, let's do it!
...
Just like that, we have our 95% CIs for our terms. In this case, if we look at the obstacles coefficient, we can see the estimate and upper/lower bounds.
