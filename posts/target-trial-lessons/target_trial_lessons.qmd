...
# What is a Target Trial and Why Emulate One?

A target trial is the

# How Do We Emulate One?

# Lessons Learned

I've been involved with several projects where the goal is to emulate a target trial. Part of my PhD project, currently underway, is to emulate a target trial. There are some key aspects/lessons that I've become aware of while working. To keep it somewhat organized, I'll lay it out as follows:
