...
survminer::ggsurvplot(survfit(Surv(time, status) ~ candy_num, 
                              data = surv_data), 
                      data = surv_data, 
                      risk.table = TRUE)

survminer::ggsurvplot(survfit(Surv(time, status) ~ sex, 
                              data = surv_data), 
                      data = surv_data, 
                      risk.table = TRUE)

survminer::ggsurvplot(survfit(Surv(time, status) ~ costume_num, 
                              data = surv_data), 
                      data = surv_data, 
                      risk.table = TRUE)
