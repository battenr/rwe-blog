...
subtitle: "The Role of Causal Estimands"
author: "Ryan Batten"
date: "2023-07-01"
...
An important component here is the concept of potential outcomes. These can be written as $Y_0$ and $Y_1$ for each person [@greifer2021choosing]. For a binary treatment, like in our case, we can think of it as each person has two *potential* outcomes **prior** to them getting the treatment or not. After they receive the treatment, only one of them is revealed [@greifer2021choosing].\
\
