...
Now we are ready to estimate some weights! We will estimate the weights using a logistic regression with the following confounders: age, sex, and time standing. Using that model we will calculate the weights, for trampoline jumpers as:\
$$
