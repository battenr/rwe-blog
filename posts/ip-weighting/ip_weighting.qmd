...
|                                    | (n = 242)      | (n = 487)      |
+====================================+:==============:+:==============:+
| Age, mean (SD)                     | 46.6 (24.3)    | 36.8 (22.1)    |
+------------------------------------+----------------+----------------+
| Female, n (%)                      | 92 (38.0)      | 237 (48.7)     |
+------------------------------------+----------------+----------------+
| T-Shirt Color, n (%)               | 85 (35.1)      | 183 (37.6)     |
|                                    |                |                |
| Orange                             | 48 (19.8)      | 136 (27.9)     |
|                                    |                |                |
| Pink                               | 71 (29.3)      | 100 (20.5)     |
|                                    |                |                |
| Blue                               | 38 (15.7)      | 68 (14.0)      |
|                                    |                |                |
| Yellow                             |                |                |
+------------------------------------+----------------+----------------+
| Brain Freeze, n (%)                | 94 (38.8)      | 218 (44.8)     |
+------------------------------------+----------------+----------------+
| Time Standing (minutes), mean (SD) | 34.9 (17.3)    | 28.1 (17.3)    |
+------------------------------------+----------------+----------------+
| Headache                           | 105 (43.4)     | 226 (46.4)     |
+------------------------------------+----------------+----------------+
...
df.weights <- df %>% 
  dplyr::mutate(
    ...
    ip_weights = dplyr::case_when(
      trampoline == 1 ~ ps.numerator/ps.denominator,
      trampoline == 0 ~ (1-ps.numerator)/(1-ps.denominator)
  )
  )
